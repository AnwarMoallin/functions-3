...
// CODE HERE
const postTaxPrices = prices.map(element => element * 1.07) // = prices.map(/* Provide Your Callback Here );
...
// CODE HERE
const totalPopulation = populations.reduce((total, population) => total + population)//  = populations.reduce(/* Provide Your Callback Here */)
// const totalPopulation = populations.reduce(function(total, population){
...
// CODE HERE
const orderTotal = orders.map(function(element){
